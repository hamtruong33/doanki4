...
<!-- /.box-header -->
<!-- form start -->
<c:form modelAttribute="category" method="post" action="${pageContext.request.contextPath }/admin/category/edit" role="form">
	<div class="box-body">
		<div class="form-group">
			<label for="exampleInputName">Name</label>
			<c:hidden path="id" value="${category.id }" />
			<c:input path="name"  type="text"
				class="form-control" id="exampleInputName" value="${category.name }" />
		</div>
