						...
						<li class="dropdown user user-menu"><a href="#"
							...
							<ul class="dropdown-menu">
								...
								<li class="user-header"><img
									...
									<p>
										${pageContext.request.userPrincipal.name} <small>Member
          ...
          <span class="input-group-btn">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="active treeview"><a
						href="${pageContext.request.contextPath}/resources/admin/product">
							<i class="fa fa-archive"></i> <span>Product</span> <span
						...
						<ul class="treeview-menu">
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/product"><i
									class="fa fa-circle-o"></i> List Product</a></li>
							<li><a
								href="${pageContext.request.contextPath}/admin/product/addproduct"><i
									class="fa fa-plus-squarev"></i> Add Product</a></li>
							<li><a
								href="${pageContext.request.contextPath}/admin/product/checkproduct"><i
									class="fa fa-plus-squarev"></i> Check Product</a></li>
						</ul></li>
					<!-- end product menu -->
					<!-- Category menu -->
					<li class="active treeview"><a
						href="${pageContext.request.contextPath}/resources/admin/category">
							<i class="fa fa-archive"></i> <span>category</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							...
							<li><a
								href="${pageContext.request.contextPath}/admin/category/addcategory"><i
									class="fa fa-plus-squarev"></i> Add category</a></li>
						</ul></li>
					<!-- End Category menu -->
					<!-- Role menu -->
					<%-- <li class="active treeview"><a
						href="${pageContext.request.contextPath}/resources/admin/role">
							<i class="fa fa-archive"></i> <span>Role</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/role"><i
									class="fa fa-circle-o"></i> List Roles</a></li>
							<li><a
								href="${pageContext.request.contextPath}/admin/role/addrole"><i
									class="fa fa-plus-squarev"></i> Add Role</a></li>
						</ul></li> --%>
					<!-- End Role menu -->

					<!-- Shop menu -->
					<li class="active treeview"><a
						href="${pageContext.request.contextPath}/resources/admin/shop">
							<i class="fa fa-archive"></i> <span>Shop</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/shop"><i
									class="fa fa-circle-o"></i> List Shop</a></li>
					...
					<!-- Account menu -->
					<li class="active treeview"><a
						href="${pageContext.request.contextPath}/resources/admin/account">
							<i class="fa fa-archive"></i> <span>Account</span> <span
							class="pull-right-container"> <i
								class="fa fa-angle-left pull-right"></i>
						</span>
					</a>
						<ul class="treeview-menu">
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/account"><i
									class="fa fa-circle-o"></i> List Account</a></li>
							<li class="active"><a
								href="${pageContext.request.contextPath}/admin/account/addaccount"><i
									class="fa fa-circle-o"></i>Add Account </a></li>
						</ul></li>
				...
				<!-- producer menu -->
				<%-- <li class="active treeview"><a
					href="${pageContext.request.contextPath}/resources/admin/producer">
						<i class="fa fa-archive"></i> <span>Producer</span> <span
						class="pull-right-container"> <i
							class="fa fa-angle-left pull-right"></i>
					</span>
				</a>
					<ul class="treeview-menu">
						<li class="active"><a
							href="${pageContext.request.contextPath}/admin/producer"><i
								class="fa fa-circle-o"></i> List Producer</a></li>
						<li><a
							href="${pageContext.request.contextPath}/admin/producer/add"><i
								class="fa fa-plus-squarev"></i> Add Producer</a></li>
					</ul></li> --%>
				<!-- end producer menu -->

				<!-- Order menu -->
				<li class="active treeview"><a
					href="${pageContext.request.contextPath}/resources/admin/order">
						<i class="fa fa-archive"></i> <span>Order</span> <span
						class="pull-right-container"> <i
							class="fa fa-angle-left pull-right"></i>
					</span>
				</a>
					<ul class="treeview-menu">
						<li class="active"><a
							href="${pageContext.request.contextPath}/admin/order"><i
								class="fa fa-circle-o"></i> List Order</a></li>
						<%-- <li><a href="${pageContext.request.contextPath}/admin/role/addrole"><i class="fa fa-plus-squarev"></i> Add Role</a></li> --%>
					</ul></li>
				<!-- End order menu -->
