...
<head>
    ...
    <title>Seller Multivendor</title>
    <!-- Tell the browser to be responsive to screen width -->
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/cssFormProfile/profileStyle.css">
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="${pageContext.request.contextPath}/seller/home" class="logo">
                <!-- mini logo for sidebar mini 50x50 pixels -->
                <span class="logo-mini"><b>A</b>LT</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>Seller</b>Multivendor</span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="${pageContext.request.contextPath}/resources/profileSellerUpload/${shop.profile}"
                                    class="user-image" alt="User Image">
                                <span class="hidden-xs">${shop.name}</span>
                            </a>
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="${pageContext.request.contextPath}/seller/profile" class="btn btn-default btn-flat">Profile</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="${pageContext.request.contextPath}/seller/home/logout" class="btn btn-default btn-flat">Sign
                                            out</a>
                                    </div>
                                </li>
                            </ul>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="${pageContext.request.contextPath}/seller/product"><i class="fa fa-circle-o"></i>
                                    List Product</a></li>
                            <li><a href="${pageContext.request.contextPath}/seller/product/add-product"><i class="fa fa-plus-squarev"></i>
                                    Add Product</a></li>
                        </ul>
                    </li>
                    <!-- end product menu -->
                    ...
                    <li class="active treeview">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="${pageContext.request.contextPath}/seller/order"><i class="fa fa-circle-o"></i>
                                    List Order</a></li>
                            <li class="active"><a href="${pageContext.request.contextPath}/seller/order/neworder"><i class="fa fa-circle-o"></i>
                                    New Order</a></li>
