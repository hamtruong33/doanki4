                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="${pageContext.request.contextPath}/seller/home/logout"
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="${pageContext.request.contextPath}/seller/product"><i
                                class="fa fa-circle-o"></i> List Product</a></li>
                        <li><a href="${pageContext.request.contextPath}/seller/product/add-product"><i
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="${pageContext.request.contextPath}/seller/order"><i
